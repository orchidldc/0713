...
<table>
  <tr>
    <td id="td2l">a. Common stock dividends</td>
    <td id="td2">F</td>
  </tr>
  <tr>
    <td id="td1l">b. General and administrative expenses</td>
    <td id="td1c">O</td>
  </tr>
  <tr>
    <td id="td1l">c. Sales and marketing expenses</td>
    <td id="td1c">O</td>
  </tr>
  <tr>
    <td id="td1l">d. Common stock issues</td>
    <td id="td1c">F</td>
  </tr>
  <tr>
    <td id="td1l">e. Common stock repurchases</td>
    <td id="td1c">F</td>
  </tr>
  <tr>
    <td id="td1l">f. Sales revenue</td>
    <td id="td1c">O</td>
  </tr>
  <tr>
    <td id="td1l">g. Research and development expenditures</td>
    <td id="td1c">I</td>
  </tr>
  <tr>
    <td id="td1l"><strong>h. Income taxes</strong></td>
    <td id="td1c">O</td>
  </tr>
  <tr>
    <td id="td1l" style="font-style:italic;">i. Additions to property and equipment<br>(增加财产和设备)</td>
    <td id="td1c">I</td>
  </tr>
  <tr>
    <td id="td3l">j. Accounts receivable</td>
    <td id="td3c">O</td>
  </tr>
</table>
...
<table>
  <tr>
    <td id="td2l">Short-term borrowing</td>
    <td id="td2">$8,406</td>
  </tr>
  <tr>
  ...
  <tr>
    <td id="td3l">Stockholders' equity</td>
    <td id="td3">$41,795</td>
  </tr>
</table>
...
<table style="font-size:11.0pt;line-height:10pt">
  <td id="td1">
    <table>
...
<font color=orange>$\boxed{\large{Formulas :}}$</font>
...
<table style="font-size:12.0pt;line-height:10pt">
  <tr>
    <td id="td2l">$\text{Reinvested dividends}_t$</td>
    <td id="td2">=</td>
    <td id="td2l">$DPS_{t-1} \times r_E$</td>
  </tr>
  <tr>
    <td id="td1l">$\text{Cum-dividend earnings}_t$</td>
    <td id="td1">=</td>
    <td id="td1l">$EPS_t+\text{Reinvested dividends}_t$</td>
  </tr>
  <tr>
    <td id="td1l">$\text{Normal earnings}_t$</td>
    <td id="td1">=</td>
    <td id="td1l">$EPS_{t-1}\times (1+r_E)$</td>
  </tr>
  <tr>
    <td id="td1l">$\text{Abnormal earnings growth}_t$</td>
    <td id="td1">=</td>
    <td id="td1l">$\text{Cum-dividend earnings}_t - \text{Normal earnings}_t$</td>
  </tr>
  <tr>
    <td id="td1l"></td>
    <td id="td1">=</td>
    <td id="td1l">$RE_t - RE_{t-1}$</td>
  </tr>
</table>
</details>
...
<table style="font-size:12.0pt;line-height:10pt">
  <tr>
    <td id="td2l">$\text{Normal forward P/E}$</td>
    <td id="td2">=</td>
    <td id="td2l">$\dfrac{1}{r}$</td>
  </tr>
  <tr>
    <td id="td1l">$\text{Normal Trailing P/E}$</td>
    <td id="td1">=</td>
    <td id="td1l">$\dfrac{1+r}{r}$</td>
  </tr>
  <tr>
    <td id="td1l">$\text{Forward P/E}$</td>
    <td id="td1">=</td>
    <td id="td1l">$\dfrac{\text{Price}_0}{\text{Eamings}_1}$</td>
  </tr>
  <tr>
    <td id="td1l">$\text{Trailing P/E}$</td>
    <td id="td1">=</td>
    <td id="td1l">$\dfrac{\text{Price}_0+\text{Dividend}_0}{\text{Eamings}_0}$</td>
  </tr>
  <tr>
    <td id="td1l">$\text{Intrinsic P/E}$</td>
    <td id="td1">=</td>
    <td id="td1l">$\dfrac{\text{Intrinsic Price}_0}{\text{Eamings}_1}$</td>
  </tr>
  <tr>
    <td id="td1l">$V_{0}^{E}$</td>
    <td id="td1">=</td>
    <td id="td1l">$\Large{\frac{1}{\rho_{E}-1}\bigg[ Earn_{1}+\frac{AEG_{2}}{\rho_{E}}+\cdots\frac{AEG_{T+1}}{\rho^{T-1}(\rho-g)}\bigg]}$</td>
  </tr>
</table>
...
<table style="font-size:12.0pt;line-height:9pt">
...
<table>
  <tr>
    <td id="td1l">$\Delta NOA$</td>
    <td id="td1l">=</td>
    <td id="td1l">OI - (C - I)</td>
  </tr>
  <tr>
    <td id="td1l"></td>
    <td id="td1l">=</td>
    <td id="td1l">390 - 430</td>
  </tr>
  <tr>
    <td id="td1l"></td>
    <td id="td1l">=</td>
    <td id="td1l">-$40 million</td>
  </tr>
</table>
...
<table>
  <tr>
    <td id="td1l">$\Delta NFO$</td>
    <td id="td1l">=</td>
    <td id="td1l">NFE + d - (C - I)</td>
  </tr>
  <tr>
    <td id="td1l"></td>
    <td id="td1l">=</td>
    <td id="td1l">43 – 13（33-20） - 430</td>
  </tr>
  <tr>
    <td id="td1l"></td>
    <td id="td1l">=</td>
    <td id="td1l">-$400 million</td>
  </tr>
</table>
  ...
  <tr>
    ...
    <td id="td1">
      ...
      <tr>
        <td id="td1l">$ROCE$</td>
        <td id="td1">=</td>
        <td id="td1l">$RNOA +[FLEV \times \colorbox{yellow}{(RNOA-NBC)}]$</td>
      </tr>
      <tr>
        <td id="td1l">13.4%</td>
        <td id="td1">=</td>
        <td id="td1l">$11.2\% +[FLEV \times (11.2\% - 4.5\%)]$</td>
      </tr>
      <tr>
        <td id="td1l">FLEV</td>
        <td id="td1">=</td>
  ...
  <tr>
    ...
    <td id="td1">
      ...
      <tr>
        <td id="td1l">$RNOA$</td>
        <td id="td1">=</td>
        <td id="td1l">$ROOA +(OLLEV \times OLSPREAD)$</td>
      </tr>
      <tr>
        <td id="td1l">11.2%</td>
        <td id="td1">=</td>
        <td id="td1l">$8.5\% +[OLLEV \times (8.5\%-4.0\%)]$</td>
      </tr>
      <tr>
        <td id="td1l">OLLEV</td>
        <td id="td1">=</td>
...
<table>
  ...
  <tr>
      <td id="td1l">$FLEV$</td>
      <td id="td1">=</td>
      <td id="td1l">$\dfrac{NFO}{CSE}$</td>
  </tr>
  <tr>
      <td id="td1l"></td>
      <td id="td1">=</td>
      <td id="td1l">$\dfrac{NFO}{NOA-NFO}$</td>
  </tr>
  <tr>
      <td id="td1l"></td>
      <td id="td1">=</td>
      <td id="td1l">$\dfrac{NFO}{405-NFO}$</td>
  </tr>
  <tr>
      <td id="td1l"></td>
      <td id="td1">=</td>
  ...
  <tr>
      <td id="td1l">$NFO$</td>
      <td id="td1">=</td>
      <td id="td1l">$\$100 million$</td>
  </tr>
  <tr>
      <td id="td1l">$CSE$</td>
      <td id="td1">=</td>
      <td id="td1l">$NOA-NFO$</td>
  </tr>
  <tr>
      <td id="td1l"></td>
      <td id="td1">=</td>
      <td id="td1l">$405-100$</td>
  </tr>
  <tr>
      <td id="td1l"></td>
      <td id="td1">=</td>
      <td id="td1l">$\$305 million$</td>
  </tr>
  </table>
  </td>
</table>
...
$OLLEV = \frac{OL}{NOA} =0.6$, So:

<table>
  <tr>
   <td id="td2l">OL</td>
   <td id="td2l">=</td>
   <td id="td2l">0.6× $405 million</td>
   <td id="td2l">Financial assets</td>
   <td id="td2l">=</td>
   <td id="td2l">total assets - operating assets</td>
  </tr>
  <tr>
   <td id="td1l"></td>
   <td id="td1l">=</td>
   <td id="td1l">$243 million</td>
   <td id="td1l"></td>
   <td id="td1l">=</td>
   <td id="td1l">715 - 648</td>
  </tr>
  <tr>
   <td id="td3l"></td>
   <td id="td3l"></td>
   ...
   <td id="td3l"></td>
   <td id="td3l">=</td>
   <td id="td3l">$67 million</td>
  </tr>
  <tr>
   <td id="td1l">OA</td>
   <td id="td1l">=</td>
   <td id="td1l">NOA +OL</td>
   <td id="td1l">Financial liabilities</td>
   <td id="td1l">=</td>
   <td id="td1l">NFO + financial assets</td>
  </tr>
  <tr>
   <td id="td1l"></td>
   <td id="td1l">=</td>
   <td id="td1l">405 + 243</td>
   <td id="td1l"></td>
   <td id="td1l">=</td>
   <td id="td1l">100 + 67</td>
  </tr>
  <tr>
   <td id="td3l"></td>
   <td id="td3l">=</td>
   <td id="td3l">$648 million</td>
   <td id="td3l"></td>
   <td id="td3l">=</td>
   <td id="td3l">$167 million</td>
  </tr>
</table>
...
<table>
  <tr>
    <td id="td1l">ROCE for 2012:&nbsp;</td>
    <td id="td1">15.20%</td>
    <td id="td1">=</td>
    <td id="td1">11.28</td>
    <td id="td1">+</td>
    <td id="td1">[0.4678 x (11.28 – 2.9)]</td>
  </tr>
  <tr>
    <td id="td1l">ROCE for 2011:&nbsp;</td>
    <td id="td1">13.30%</td>
    <td id="td1">=</td>
    <td id="td1">12.75</td>
    <td id="td1">+</td>
    <td id="td1">[0.0577 x (12.75 – 3.2)]</td>
  </tr>
  <tr>
    <td id="td1l" style="color:#4472C4;">ΔROCE</td>
    <td id="td1" style="color:#4472C4;">1.90%</td>
    <td id="td1"></td>
    <td id="td1"></td>
    <td id="td1"></td>
    <td id="td1"></td>
  ...
  <tr>
    <td id="td1l" style="color:#4472C4;">ΔRNOA</td>
    <td id="td1"></td>
    <td id="td1"></td>
    <td id="td1" style="color:#4472C4;">-1.47%</td>
    <td id="td1"></td>
    <td id="td1"></td>
  </tr>
  <tr>
    <td id="td1l" style="color:#4472C4;">ΔROCE due to financing</td>
    <td id="td1"></td>
    <td id="td1"></td>
    <td id="td1"></td>
    <td id="td1"></td>
    <td id="td1c" style="color:#4472C4;">3.37%</td>
  </tr>
</table>
...
<table>
  <tbody>
    <tr>
      <td id="td1c"></td>
      <td id="td1l" colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;ΔROCE due to financing (3.37%)</td>
    </tr>
    <tr>
      <td id="td1c">=</td>
      <td id="td1c">ΔSPREAD×FLEV_0</td>
      <td id="td1c">+</td>
      <td id="td1c">ΔFLEV×SPREAD_1</td>
    </tr>
    <tr>
      <td id="td1c">=</td>
      <td id="td1c">-1.17% x 0.0577</td>
      <td id="td1c">+</td>
      <td id="td1c">0.4101 x 8.38%</td>
    </tr>
    <tr>
      <td id="td1c">=</td>
      <td id="td1c">-0.07%</td>
    ...
    <tr>
      <td id="td1c"></td>
      <td id="td1c">Due to change in spread</td>
      <td id="td1c"></td>
      <td id="td1c">Due to change in leverage</td>
    </tr>
  </tbody>
</table>
</details>
